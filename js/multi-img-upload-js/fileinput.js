    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tActions = '<div class="file-actions">\n' +
                ...
                '        {rotate} <a class="kv-file-download btn btn-sm btn-kv btn-default btn-outline-secondary" title="{downloadTitle}" ' +
                'href="{downloadUrl}" download="'+{tActionDownload}+'" target="_blank"><i class="bi-download"></i></a> {download} {upload} {delete} {zoom} {other}' +
                '    </div>\n' +
                '</div>\n' +
                '{drag}\n' +
                '<div class="newit">Fuel Injection Pump Plate Image</div>\n' +
                '<div class="clearfix"></div>';
            //noinspection HtmlUnknownAttribute
